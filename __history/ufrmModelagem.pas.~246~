...
type
  TfrmModelagem = class(TForm)
    ...
    QrModelagemMT_COMPRA1: TBCDField;
    QrModelagemMT_COMPRA2: TBCDField;
    QrModelagemFACA_TIPO: TStringField;
    QrModelagemFACA_MD1: TIntegerField;
    QrModelagemFACA_MD2: TIntegerField;
    QrModelagemCODIGO: TStringField;
  ...
  private
    ...
    procedure RemoverLinhaSeZero(var HTML: string; const Placeholder,
      Valor: string);
    function ValorInvalido(const S: string): Boolean;
...
procedure  TfrmModelagem.RemoverLinhaSeZero(var HTML: string; const Placeholder, Valor: string);
var
  Inicio, Fim: Integer;
  Linha: string;
begin
  if StrToFloatDef(StringReplace(Valor, ',', '.', [rfReplaceAll]), 0) = 0 then
  begin
    // procura a linha que contém o placeholder
    Inicio := Pos('<tr', LowerCase(HTML));
    while Inicio > 0 do
    begin
...
function TfrmModelagem.ValorInvalido(const S: string): Boolean;
var
  V: Double;
  Texto: string;
begin
...
begin
  ...
  LHTML_Base := TStringList.Create;
  LHTML := TStringList.Create;

  LHTML.LoadFromFile(pubDirEXE + 'index.html');
  LHTML_Base.LoadFromFile(pubDirEXE + 'base.html');

  // === OCULTAR LINHAS SE ZERO OU VAZIO ===

  if ValorInvalido(edt_medida_maior1.Text) then
    LHTML_Base.Text := StringReplace(LHTML_Base.Text,
      'id="linha_medida_maior1"',
      'id="linha_medida_maior1" style="display:none;"',
      [rfIgnoreCase]);

  if ValorInvalido(edt_medida_maior2.Text) then
    LHTML_Base.Text := StringReplace(LHTML_Base.Text,
      'id="linha_medida_maior2"',
      'id="linha_medida_maior2" style="display:none;"',
      [rfIgnoreCase]);

  if ValorInvalido(edt_medida_menor1.Text) then
    LHTML_Base.Text := StringReplace(LHTML_Base.Text,
      'id="linha_medida_menor1"',
      'id="linha_medida_menor1" style="display:none;"',
      [rfIgnoreCase]);

  if ValorInvalido(edt_medida_menor2.Text) then
    LHTML_Base.Text := StringReplace(LHTML_Base.Text,
      'id="linha_medida_menor2"',
      'id="linha_medida_menor2" style="display:none;"',
      [rfIgnoreCase]);

  if ValorInvalido(edt_metragem_compra1.Text) then
    LHTML_Base.Text := StringReplace(LHTML_Base.Text,
      'id="linha_mt_compra1"',
      'id="linha_mt_compra1" style="display:none;"',
      [rfIgnoreCase]);

  if ValorInvalido(edt_metragem_compra2.Text) then
    LHTML_Base.Text := StringReplace(LHTML_Base.Text,
      'id="linha_mt_compra2"',
      'id="linha_mt_compra2" style="display:none;"',
      [rfIgnoreCase]);
  ...
  QrModelagemMAX_ACEITAVEL.AsInteger         := Trunc(SafeStrToInt(edt_max_aceitavel.Text));
  ...
  QrModelagemMT_COMPRA1.AsFloat := SafeStrToInt(edt_metragem_compra1.Text);
  QrModelagemMT_COMPRA2.AsFloat := SafeStrToInt(edt_metragem_compra2.Text);
  QrModelagemFACA_TIPO.AsString  := CbTipoFaca.Value;
    ...
    case TipoCorte of
      0: begin
           ...
           begin
            ...
            LHTML.Text := StringReplace(LHTML.Text, '__table3__', LHTML_table.Text, [rfIgnoreCase, rfReplaceAll]);
      ...
      1: begin
            ...
            LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa_altura]', edt_crack_chapa1.Text, [rfIgnoreCase, rfReplaceAll]);
            LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa_largura]',edt_crack_chapa2.Text, [rfIgnoreCase, rfReplaceAll]);
            LHTML_table.Text := StringReplace(LHTML_table.Text, '[pecas_chapa]', edt_crack_pc.Text, [rfIgnoreCase, rfReplaceAll]);
            LHTML_table.Text := StringReplace(LHTML_table.Text, '[qtd_chapas]', edt_crack_qc.Text, [rfIgnoreCase, rfReplaceAll]);
      ...
      2: begin
           ...
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa_altura]', edt_laserp1_chapa1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa_largura]',edt_laserp1_chapa2.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[pecas_chapa]', edt_laserp1_pc.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[qtd_chapas]', edt_laserp1_qc.Text, [rfIgnoreCase, rfReplaceAll]);
           ...
           begin
             ...
             LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa_altura]', edt_laserp2_chapa1.Text, [rfIgnoreCase, rfReplaceAll]);
             LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa_largura]',edt_laserp2_chapa2.Text, [rfIgnoreCase, rfReplaceAll]);
             LHTML_table.Text := StringReplace(LHTML_table.Text, '[pecas_chapa]', edt_laserp2_pc.Text, [rfIgnoreCase, rfReplaceAll]);
             LHTML_table.Text := StringReplace(LHTML_table.Text, '[qtd_chapas]', edt_laserp2_qc.Text, [rfIgnoreCase, rfReplaceAll]);
      ...
      3: begin
           ...
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa_altura]', edt_laserm1_chapa1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa_largura]',edt_laserm1_chapa2.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[pecas_chapa]', edt_laserm1_pc.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[qtd_chapas]', edt_laserm1_qc.Text, [rfIgnoreCase, rfReplaceAll]);
           ...
           begin
             ...
             LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa_altura]', edt_laserm2_chapa1.Text, [rfIgnoreCase, rfReplaceAll]);
             LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa_largura]',edt_laserm2_chapa2.Text, [rfIgnoreCase, rfReplaceAll]);
             LHTML_table.Text := StringReplace(LHTML_table.Text, '[pecas_chapa]', edt_laserm2_pc.Text, [rfIgnoreCase, rfReplaceAll]);
             LHTML_table.Text := StringReplace(LHTML_table.Text, '[qtd_chapas]', edt_laserm2_qc.Text, [rfIgnoreCase, rfReplaceAll]);
      ...
      4: begin
           ...
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa_altura]', edt_laserg1_chapa1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa_largura]',edt_laserg1_chapa2.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[pecas_chapa]', edt_laserg1_pc.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[qtd_chapas]', edt_laserg1_qc.Text, [rfIgnoreCase, rfReplaceAll]);
           ...
           begin
             ...
             LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa_altura]', edt_laserg2_chapa1.Text, [rfIgnoreCase, rfReplaceAll]);
             LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa_largura]',edt_laserg2_chapa2.Text, [rfIgnoreCase, rfReplaceAll]);
             LHTML_table.Text := StringReplace(LHTML_table.Text, '[pecas_chapa]', edt_laserg2_pc.Text, [rfIgnoreCase, rfReplaceAll]);
             LHTML_table.Text := StringReplace(LHTML_table.Text, '[qtd_chapas]', edt_laserg2_qc.Text, [rfIgnoreCase, rfReplaceAll]);
      ...
      5: begin
           ...
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa_altura]', edt_lasermontg1_chapa1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa_largura]', edt_lasermontg1_chapa2.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[pecas_chapa]',edt_lasermontg1_pc.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[rec1]',edt_lasermontg1_recorte1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[rec2]', edt_lasermontg1_recorte2.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[horrec]', edt_lasermontg1_hvrec1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[vertrec]', edt_lasermontg1_hvrec2.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[qtd_qd]', edt_lasermontg1_qeq.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[qtd_chapas]', edt_lasermontg1_qc.Text, [rfIgnoreCase, rfReplaceAll]);
           ...
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa_altura]', edt_lasermontg2_chapa1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa_largura]', edt_lasermontg2_chapa2.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[pecas_chapa]',edt_lasermontg2_pc.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[rec1]',edt_lasermontg2_recorte1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[rec2]', edt_lasermontg2_recorte2.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[horrec]', edt_lasermontg2_hvrec1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[vertrec]', edt_lasermontg2_hvrec2.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[qtd_qd]', edt_lasermontg2_qeq.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[qtd_chapas]', edt_lasermontg2_qc.Text, [rfIgnoreCase, rfReplaceAll]);
      ...
      6: begin
           ...
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[hor]', edt_galvo_hv1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[vert]', edt_galvo_hv2.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[deslocamento]',edt_galvo_desloc.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[etq_prog]', edt_galvo_etqpp.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[etq_tira]', edt_galvo_etpt.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[galvo1]', edt_galvo_tg1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[galvo2]', edt_galvo_tg2.Text, [rfIgnoreCase, rfReplaceAll]);
      ...
      7: begin
           ...
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[hor]', edt_galvofinal_hv1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[vert]', edt_galvofinal_hv2.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[deslocamento]',edt_galvofinal_desloc.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[etq_prog]', edt_galvofinal_etqpp.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[etq_tira]', edt_galvofinal_etpt.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[galvo1]', edt_galvofinal_tg1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[galvo2]', edt_galvofinal_tg2.Text, [rfIgnoreCase, rfReplaceAll]);
      ...
      8: begin
           ...
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[hor]', edt_crackchapado_hv1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[vert]', edt_crackchapado_hv2.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[qs1]',edt_crackchapado_qts1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[qs2]', edt_crackchapado_qts2.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[ac1]', edt_crackchapado_area1crack.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[ac2]', edt_crackchapado_area2crack.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[h2]', edt_crackchapado_hv12.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[v2]', edt_crackchapado_hv22.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa1]', edt_crackchapado_chapa1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa2]', edt_crackchapado_chapa2.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[etqc]', edt_crackchapado_etc.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[qtdc]', edt_crackchapado_qtc.Text, [rfIgnoreCase, rfReplaceAll]);
      ...
      9: begin
           ...
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[hor]', edt_crackchapadosemfaca_hv1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[vert]', edt_crackchapadosemfaca_hv2.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[qs1]',edt_crackchapadosemfaca_qts1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[qs2]', edt_crackchapadosemfaca_qts2.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[ac1]', edt_crackchapadosemfaca_area1laser.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[ac2]', edt_crackchapadosemfaca_area2laser.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[h2]', edt_crackchapadosemfaca_hv12.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[v2]', edt_crackchapadosemfaca_hv22.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa1]', edt_crackchapadosemfaca_chapa1.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[chapa2]', edt_crackchapadosemfaca_chapa2.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[etqc]', edt_crackchapadosemfaca_etc.Text, [rfIgnoreCase, rfReplaceAll]);
           LHTML_table.Text := StringReplace(LHTML_table.Text, '[qtdc]', edt_crackchapadosemfaca_qtc.Text, [rfIgnoreCase, rfReplaceAll]);
