object frmProducao: TfrmProducao
  ...
  object Panel2: TPanel
    ...
    object Label4: TLabel
      ...
      Width = 110
      Height = 13
      Caption = 'N'#176' do Pedido de Venda'
    end
    ...
    object DtEntrega: TDateTimePicker
      ...
      Width = 145
      Height = 21
      Date = 45809.000000000000000000
      Time = 0.467803564817586400
      TabOrder = 4
    end
  ...
  object WebBrowserImp: TWebBrowser
    Left = 519
    Top = 168
    Width = 481
    Height = 180
  ...
  object QrModelos: TFDQuery
    ...
    SQL.Strings = (
      ...
      ''
      'WHERE UPPER(nome_etiqueta) LIKE UPPER(:param)')
    Left = 240
    Top = 8
    ParamData = <
      item
  ...
  object QrSaveProd: TFDQuery
    ...
    object QrSaveProddadosModelagem: TMemoField
      FieldName = 'dadosModelagem'
      BlobType = ftMemo
    end
    object QrSaveProdn_pedido: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'n_pedido'
      Origin = 'n_pedido'
      Size = 255
  ...
  object QrLastProd: TFDQuery
    ...
    Left = 496
    Top = 536
    object QrLastProdPEDIDO: TIntegerField
      FieldName = 'PEDIDO'
      Origin = 'PEDIDO'
      Required = True
    end
