...
type
  TfrmMain = class(TForm)
    ...
    procedure fVersaoDblClick(Sender: TObject);
  private
...
begin
  T.Exibe(TfrmProducoesEnv, frmProducoesEnv);
end;
...
procedure TfrmMain.fVersaoDblClick(Sender: TObject);
begin
...
begin
  ...
  begin
    ...
    AvisoAtt('Desativado o modo de atualização automático', 1, -2);
  end
  else
  begin
    tmprocessa.Enabled := true;
